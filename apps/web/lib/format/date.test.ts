...
import { daysUntilDate, formatKoreanScheduleDateTime, formatKoreanTime, relativeDayLabel } from "./date";
...
describe("date formatting", () => {
  ...
  it("uses Korean day periods regardless of the runtime locale", () => {
    ...
    expect(formatKoreanTime("2026-08-31T15:00:00.000Z")).toBe("오전 12:00");
    expect(formatKoreanTime("2026-09-01T03:00:00.000Z")).toBe("오후 12:00");
    expect(formatKoreanTime("2026-09-01T14:59:00.000Z")).toBe("오후 11:59");
  });

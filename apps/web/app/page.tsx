    ...
    <main className="marketing-page">
      ...
      <section className="marketing-hero">
        <div className="marketing-hero-copy">
          <span className="eyebrow">임대 운영의 다음 기준</span>
          <h1><span>건물 관리의 불확실성을 줄이고,</span><br /><strong>오늘 할 일에 집중하세요.</strong></h1>
        ...
        <div className="marketing-visual" aria-label="렌트플로우 오늘의 브리핑 미리보기">
          <Image src="/assets/rentflow/hero-night-building.jpg" fill sizes="(max-width: 900px) 92vw, 48vw" alt="야간 도심 건물 전경" priority />
      ...
      <footer className="marketing-footer"><Image src="/assets/rentflow/brand-lockup.png" width={120} height={38} alt="렌트플로우" /><p>임대 운영의 불확실성을 오늘의 명확한 조치로 바꿉니다.</p><Link href="/login">데모 로그인</Link></footer>
    </main>
  );
}
